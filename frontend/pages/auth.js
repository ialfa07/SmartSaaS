      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-16">
        ...
        >
          ...
          <div className="text-center mb-8">
            <h2 className="text-4xl font-bold mb-3 text-gradient" style={{ 
            ...
            <p style={{ 
              ...
              {isLogin 
                ? 'Bon retour sur SmartSaaS ! Continuez à révolutionner votre marketing.' 
                : 'Rejoignez la révolution du marketing IA et transformez votre business.'
              }
            </p>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <button className="w-full btn btn-secondary btn-lg card-interactive flex items-center justify-center space-x-3">
              ...
              <span style={{ fontWeight: 'var(--font-weight-medium)' }}>Continuer avec Google</span>
            </button>
            ...
            <button className="w-full btn btn-secondary btn-lg card-interactive flex items-center justify-center space-x-3">
              ...
              <span style={{ fontWeight: 'var(--font-weight-medium)' }}>Continuer avec GitHub</span>
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {!isLogin && (
              <div className="form-group">
                ...
                <div className="form-help">
                  Utilisez votre vrai nom pour personnaliser votre expérience
                </div>
              </div>
            )}
            ...
            <div className="form-group">
              ...
              />
              <div className="form-help">
                {isLogin ? 'Votre mot de passe sécurisé' : 'Minimum 8 caractères recommandés'}
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full btn btn-primary btn-xl ${loading ? 'btn-loading' : ''}`}
            >
              {!loading && (
                <>
                  <span className="mr-2">
